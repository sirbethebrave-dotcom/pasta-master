...
${constraints.query ? `ВАЖНО! Дополнительные пожелания пользователя: "${constraints.query}" - обязательно учти эти пожелания в рецепте!` : ''}

КРИТИЧЕСКИ ВАЖНЫЕ ТРЕБОВАНИЯ:
- Используй ТОЛЬКО указанные ингредиенты (можно добавить базовые: соль, перец, оливковое масло)
- НЕ добавляй никаких других ингредиентов, которых нет в списке
- ${constraints.query ? `ОБЯЗАТЕЛЬНО учти пожелания: "${constraints.query}"` : ''}
